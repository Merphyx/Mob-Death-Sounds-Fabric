package de.myronx.mobdeathsound.config;
...
public class MobDeathSoundConfig {
    ...
    public static Identifier soundEvent = Identifier.of("entity.experience_orb.pickup");
    public static final Identifier DEFAULT_SOUND_EVENT = Identifier.of("entity.experience_orb.pickup");
    ...
    public void loadConfig() {
        ...
        try (FileReader reader = new FileReader(configFile)) {
            ...
            soundEvent = Identifier.of(json.get("soundEvent").getAsString());
